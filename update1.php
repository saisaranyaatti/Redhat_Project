      ...
      <?php
            ...
            if(!empty($uname) || !empty($email) || !empty($roll) || !empty($gender) || !empty($college) || !empty($branch) ){
               ...
               $res=mysqli_query($con,$insert);
                  if($res){
                      echo "<script>alert('Successfully Updated');location.href='profile1.php'</script>";
                  }
                  else{
                      echo "<script>alert('Not Updated,Please retry it');location.href='update1.php'</script>";
                  }
              }
            }else{
   ...
   <div class="container">
      ...
      <div class="row" style="margin-top: 100px;">
         ...
         <div >
         	...
         	<form class="form-group" method = "post" action="update1.php">         
